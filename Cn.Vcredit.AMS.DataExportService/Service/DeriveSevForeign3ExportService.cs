...
namespace Cn.Vcredit.AMS.DataExportService.Service
{
    ...
    /// </summary>
    [Description("导出外贸数据3")]
    public class DeriveSevForeign3ExportService : BaseService.Service.BaseService
    {
        /// <summary>
        /// 程序执行主入口
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 导出外贸数据3
            Singleton<DeriveSevForeign3ExportBLL>.Instance.ExportData(filter, responseEntity);
        }
    }
}
