...
namespace Cn.Vcredit.AMS.DataExportService.DAL
{
    ...
    /// Description:导出外贸数据2数据处理类
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DeriveSevForeignExportDAL<T>
        : BaseSearchDAL<T> where T : class, new()
    {
        ...
        {
            return "proc_FinanceManage_GetTable2ByDWJM";
        }
        ...
        protected override IDictionary<string, object> GetSearchSpInParams(BaseFilter baseFilter)
        {
            ...
            inPutParam.Add("@AccountID", filter.AccountID);
            inPutParam.Add("@ServiceSide", filter.ServiceSide);
            inPutParam.Add("@ReceiveType", filter.ReceiveType);
