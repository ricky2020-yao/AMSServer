...
AccountID={0} ,CompanyKey = b.CompanyKey,
IdenNo = c.IdenNo,SerialNo='',BankKey = bus.BankKey,
CreateTime =getdate(),IsLock=0,OnlySubject = 23,PeriodType = 13,0,'{2}'
FROM BillItem as a 
...
and bus.CLoanStatus not in (5,6,7) and b.IsShelve=0 and a.Subject =23
and bus.FrozenNo='' and b.BillType!=5 and bus.ServiceSideKey !='' AND bus.ProductType = 4
