...
namespace Cn.Vcredit.AMS.Logic.BLL.FinanceProducts
{
    ...
    /// Description:车辆抵押贷款
    /// </summary>
    public class CarMortgageLoan:VcreditProduct
    {
        #region- 字段属性 -
        ...
        //public CarMortgageLoan(Business business) : base(business) { }
        #endregion
        ...
        {
            return Singleton<SubjectDictionary>.Instance.CarMortgageLoanDic;
        }
        #endregion
    }
}
