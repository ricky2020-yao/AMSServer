...
namespace Cn.Vcredit.AMS.SavingCardChangeService.DAL
{
    ...
    /// Description:查询储蓄卡历史修改信息数据层操作类
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class GetSavingCardChangeHistoryDAL<T>
        : BaseSearchDAL<T> where T : class, new()
    {
        ...
        {
            return "proc_BillDun_GetSavingCardChangeHistory";
        }
        ...
        protected override IDictionary<string, object> GetSearchSpInParams(BaseFilter baseFilter)
        {
            ...
            if (filter.RegionKey != null)
                inPutParam.Add("@RegionKey", filter.RegionKey);
