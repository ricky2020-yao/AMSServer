...
namespace Cn.Vcredit.AMS.SavingCardChangeService.DAL
{
    ...
    /// Description:储蓄卡变更提交修改数据层操作类
    /// </summary>
    public class SavingCardChangeSubmitDAL:BaseUpdateDAL
    {
        /// <summary>
        /// 获取指定如何解释命令字符串
        /// </summary>
        ...
        protected override string GetUpdateSql(BaseFilter baseFilter)
        {
            ...
            string sql = "Services\\SQL\\SavingCardChange\\INSERT_SAVINGCARDCHANGE_HISTORY.sql";
