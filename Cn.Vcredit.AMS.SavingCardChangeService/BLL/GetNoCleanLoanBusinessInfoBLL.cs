...
namespace Cn.Vcredit.AMS.SavingCardChangeService.BLL
{
    ...
    /// Description:储蓄卡变更获取出未清贷的业务信息逻辑处理类
    /// </summary>
   public class GetNoCleanLoanBusinessInfoBLL:BaseBLL
   {
       /// <summary>
       /// 根据条件查询数据
       /// </summary>
           ...
           , ResponseEntity responseEntity)
       {
           ...
           var reportDetailList = Singleton<SavingCardChangeDAL<SavingCardChangeModifyViewData>>
           ...
           else
           {
               ...
               var responseResult = new ResponseListResult<SavingCardChangeModifyViewData>();
       ...
       private void SetBranchName(List<SavingCardChangeModifyViewData> lstData)
       {
