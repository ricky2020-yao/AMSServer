...
namespace Cn.Vcredit.AMS.GuarLitigationService.Service
{
    ...
    /// Description:担保和诉讼设置批量转担保服务
    /// </summary>
    [Description("担保和诉讼设置批量转担保服务")]
    public class GuarLitigationInBatchNumService:BaseService.Service.BaseService
    {
        /// <summary>
        /// 程序执行主入口
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 担保和诉讼设置导出
            Singleton<GuarLitigationInBatchNumBLL>.Instance.BatchConvertGurantee(filter, responseEntity);
        }
    }
}
