...
namespace Cn.Vcredit.AMS.SavingCardChangeService.Service
{
    ...
    /// Description:每日逾期静态报表查询服务
    /// </summary>
    [Description("每日逾期静态报表查询服务")]
    public class EveryDueReportSearchService : BaseService.Service.BaseService
    {
        /// <summary>
        /// 程序执行主入口
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 每日逾期静态报表查询服务
            Singleton<EveryDueReportSearchBLL>.Instance.Search(filter, responseEntity);
        }
    }
}
