...
namespace Cn.Vcredit.AMS.EveryDueRepayReportService.Service
{
    ...
    /// Description:每日逾期客户还款明细报表导出服务
    /// </summary>
    [Description("每日逾期客户还款明细报表导出服务")]
    public class EveryDueRepayReportExportService:BaseService.Service.BaseService
    {
        /// <summary>
        /// 程序执行主入口
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 客户查询
            Singleton<EveryDueRepayReportExportBLL>.Instance.SearchData(filter, responseEntity);
        }
    }
}
