...
namespace Cn.Vcredit.AMS.BusinessService.Service
{
    ...
    /// Desc:订单详情-账单查询服务
    /// </summary>
    [Description("订单详情-账单查询服务")]
    public class BillDetailService : BaseService.Service.BaseService
    {
        /// <summary>
        /// 服务执行
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 检索数据
            Singleton<BaseSearchBLL<BillDetailViewData
                , BillDetailDAL<BillDetailViewData>>>.Instance.SearchData(filter, responseEntity);
        }
    }
}
