...
namespace Cn.Vcredit.AMS.BusinessService.Service
{
    ...
    /// Desc:订单详情-填账服务
    /// </summary>
    [Description("订单详情-填账服务")]
    public class BusinessPayAccountService:BaseService.Service.BaseService
    {
        /// <summary>
        /// 服务执行
        /// </summary>
        ...
        protected override void DoExecute(RequestEntity requestEntity, ResponseEntity responseEntity)
        {
            ...
            // 数据填账
            Singleton<BusinessPayAccountBLL>.Instance.PayAccount(filter, responseEntity);
        }
    }
}
